...
و اگر ترجیح می‌دهید دستی نصب کنید، در chrome://extensions گزینه‌ی **Load unpacked** را روی همان پوشه بزنید: `extension`
...
نوشته‌ی رضا باقری، با مجوز MIT — [rezabagheri6](https://github.com/rezabagheri6)
